...
struct User {
    ...
    static var currentUser: User = User(userName: "Angel Mor", email: "angel4761.be23@gmail.com", age: 20)
...
let user = User(userName: "Angel Mor", email: "angel4761.be23@gmail.com", age: 20)
